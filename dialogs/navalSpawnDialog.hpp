// Control IDs
#define IDD_SPAWN_DIALOG 4000
#define IDC_TITLE 4001
#define IDC_UNIT_LIST 4002
#define IDC_DEPLOYMENT_LIST 4003
#define IDC_UNIT_IMAGE 4004
#define IDC_UNIT_INFO 4005
#define IDC_STATIC_BUTTON 4006
#define IDC_UNIT_STATUS 4007
#define IDC_STATUS_AREA 4008
#define IDC_DEPLOY_BUTTON 4009
#define IDC_CLOSE_BUTTON 4010

class RscNavalSpawnDialog
{
    ...
    class Controls
    {
        ...
        class UnitList: RscListBox
        {
            ...
            h = 0.95;
            sizeEx = 0.032;
            onLBSelChanged = "_this call EAS_fnc_onVehicleSelect;";
        };
        ...
        class DeployButton: RscButton
        {
            ...
            onButtonClick = "_this call EAS_fnc_loadNaval;";
        };
